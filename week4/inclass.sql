...
start_time time,
stop_time time,
PRIMARY KEY (client_id, entertainer_id, engagement_date, start_time),
FOREIGN KEY (entertainer_id) references entertainers(entertainer_id));
...
SELECT * FROM clients, engagements ORDER BY clients.client_id desc;
...
SELECT * FROM agent_client_engagement_view;
